package com.aaa.qy111mp.generator;
...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("AAATeacherChen");//作者
        ...
        sourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/student?characterEncoding=utf8");
        ...
        packageConfig.setParent("com.aaa.qy111mp");// 自定义包路径
